...
with open('football_players.txt', 'w') as file:
      for player in df:
            file.write(f'{random.randint(80,99)},{random.randint(30,45)},{random.randint(25,35)},defender,{player}\n')
      for player in mf:
            file.write(f'{random.randint(30,45)},{random.randint(80,99)},{random.randint(45,55)},midfielder,{player}\n')
      for player in fw:
            file.write(f'{random.randint(35,45)},{random.randint(30,45)},{random.randint(80,99)},striker,{player}\n')
